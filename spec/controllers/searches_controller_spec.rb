  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved search as @search" do
        ...
        post :create, {:search => { "doctor" => "invalid value" }}, valid_session
        assigns(:search).should be_a_new(Search)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested search" do
        ...
        Search.any_instance.should_receive(:update_attributes).with({ "doctor" => "MyString" })
        put :update, {:id => search.to_param, :search => { "doctor" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the search as @search" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Search.any_instance.stub(:save).and_return(false)
        put :update, {:id => search.to_param, :search => { "doctor" => "invalid value" }}, valid_session
        assigns(:search).should eq(search)
      end
