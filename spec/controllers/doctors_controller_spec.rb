...
describe DoctorsController do
  ...
  def valid_attributes
    { "name" => "doctor_name", :department_id => 1 }
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved doctor as @doctor" do
        ...
        post :create, {:doctor => { "checkup_time" => "invalid value" }}, valid_session
        assigns(:doctor).should be_a_new(Doctor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested doctor" do
        ...
        Doctor.any_instance.should_receive(:update_attributes).with({ "checkup_time" => "1.5" })
        put :update, {:id => doctor.to_param, :doctor => { "checkup_time" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the doctor as @doctor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Doctor.any_instance.stub(:save).and_return(false)
        put :update, {:id => doctor.to_param, :doctor => { "checkup_time" => "invalid value" }}, valid_session
        assigns(:doctor).should eq(doctor)
      end
