...
module DoctorSearch
  class Application < Rails::Application
    ...
    # source::  http://everydayrails.com/2012/03/12/testing-series-rspec-setup.html
    config.generators do |g|
       g.test_framework :rspec,
        # generate a fixture for each model (using a Factory Girl factory, instead of an actual fixture)
        :fixtures => true
      #   :view_specs => false,
      #   :helper_specs => false,
      #   :routing_specs => false,
